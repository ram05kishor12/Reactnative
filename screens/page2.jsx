...
const Page2 = ({ navigation }) => {
  ...
  return (
    <View className="flex-1 flex-col justify-center items-center">
      <Text className="font-bold text-lg mt-4">Page 2</Text>
      ...
      <TouchableOpacity className="font-bold bg-gray mt-4 p-6 shadow-sm rounded-full"onPress={() => navigation.navigate('Page3')} >
        <Text className="text-black font-bold">Go to Page 3</Text>
      </TouchableOpacity>
    </View>
  );
};
